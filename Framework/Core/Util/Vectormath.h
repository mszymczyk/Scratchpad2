...
#define rad2deg( x ) ((x) * (180.0f / PI))
	...
	inline Matrix4 perspectiveProjectionDxStyle( float fovyRadians, float aspect, float zNear, float zFar )
	{
		Matrix4 proj = Matrix4::perspective( fovyRadians, aspect, zNear, zFar );
		// dx style projection, z in <0,1> range
