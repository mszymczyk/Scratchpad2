...
namespace spad
{
	...
	struct MeshVertex
	{
		...
		MeshVertex( const Float3& p, const Float3& n, const Float2& tc, const Float3& t, const Float3& b )
		{
			Position = p;
			Normal = n;
			TexCoord = tc;
	...
	public:
		...
		void InitFromAssimpMesh( ID3D11Device* device, const aiMesh& assimpMesh, float sceneScale );
	...
	public:
		...
		void CreateWithAssimp( ID3D11Device* device, const char* filename, float sceneScale );
