...
protected:
	...
	static ID3D11RasterizerState* wireframeBackFaceCull;
...
public:
	...
	static ID3D11RasterizerState* WireframeBackFaceCull() { return wireframeBackFaceCull; };
	...
	static D3D11_RASTERIZER_DESC WireframeBackFaceCullDesc();
};
